...
public class trinity {
	...
	public String trinityFileStart(int nrOfSequences,String inDir, String outDir, String timestamp, int count, SBATCHinfo sbatch,ExtendedWriter EW ){
	...
	public void trinityDirPE( ExtendedWriter generalSbatchScript, SBATCHinfo sbatch ,String timestamp,String inDir, String outDir, int insertSize ){
		...
		if(fileNames.isEmpty()){
			...
			try{
				...
				String memory = trinityFileStart(nrOfSequences,  inDir,  outDir,  timestamp,  count,  sbatch, EW);
				int CPUs = 8;
